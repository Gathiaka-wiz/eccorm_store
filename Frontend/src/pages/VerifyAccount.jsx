...
const VerifyAccountPage = () => {
	...
	return (
		<div className="min-h-screen grid cent">
			<motion.form
			...
			>
				<h1 className="text-3xl font-bold text-center font-[Supreme-ExtraBold] text-[#171717] ">
					Verify your Account
				</h1>
				<p className="text-sm font-bold text-center font-[Supreme-ExtraBold] text-[#171717]   ">
					Check you email for 6 digit code
				</p>
